...
if __name__ == "__main__":
    try:
        ...
        # Now load the test dataset (emotions_for_test.csv)
        test_data = load_data("processed/emotions_for_test.csv")

        # Preprocess the test data (use the same tokenizer from training)
        ...
        print(f"Test Accuracy on Validation Data: {accuracy * 100:.2f}%")
